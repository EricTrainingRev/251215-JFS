...
- IDEs
    - [Visual Studio Code](https://code.visualstudio.com/Download)
        ...
        - the "Extension Pack for Java" extension has a great starting collection of extensions for working with Java and Gradle in VSC, you should install them
        - VSC does not come with a JDK, so you will need to acquire one on your own. With the Java extensions you can use the VSC command pallet to download a JDK for use. I recommend the Temurin distribution
            - we will use JDK 21 in training
        - if you want to use Gradle with VSC you will need to download it and set it up for use: [this](https://gradle.org/install/) link will take you to the download page, which also includes setup instructions for configuring Gradle to work on your machine
    - [Intellij](https://www.jetbrains.com/idea/download/?fromIDE=&section=windows)
        ...
        - Intellij comes bundled with a Gradle wrapper and has an internal system for downloading and using JDKS, when setting up a project you can have Intellij download the JDK you need
